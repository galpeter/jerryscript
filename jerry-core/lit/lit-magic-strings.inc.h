...
#endif
#if (defined (JERRY_BUILTIN_ARRAY) && (JERRY_BUILTIN_ARRAY == 1)) \
&& (defined (JERRY_ES2015_BUILTIN) && (JERRY_ES2015_BUILTIN == 1)) \
|| (defined (JERRY_ES2015_BUILTIN_TYPEDARRAY) && (JERRY_ES2015_BUILTIN_TYPEDARRAY == 1))
...
#endif
#if (defined (JERRY_BUILTIN_ARRAY) && (JERRY_BUILTIN_ARRAY == 1)) \
&& (defined (JERRY_ES2015_BUILTIN_ITERATOR) && (JERRY_ES2015_BUILTIN_ITERATOR == 1))
...
#if (defined (JERRY_BUILTIN_ANNEXB) && (JERRY_BUILTIN_ANNEXB == 1)) \
&& (defined (JERRY_BUILTIN_REGEXP) && (JERRY_BUILTIN_REGEXP == 1))
...
#endif
#if (defined (JERRY_BUILTIN_ANNEXB) && (JERRY_BUILTIN_ANNEXB == 1)) \
&& (defined (JERRY_BUILTIN_DATE) && (JERRY_BUILTIN_DATE == 1))
