...
#endif
#if  defined(JERRY_BUILTIN_ARRAY) && (JERRY_BUILTIN_ARRAY == 1) && !defined (CONFIG_DISABLE_ES2015_BUILTIN) \
|| !defined (CONFIG_DISABLE_ES2015_TYPEDARRAY_BUILTIN)
...
|| !defined (CONFIG_DISABLE_ES2015_SYMBOL_BUILTIN)
...
#endif
#if  defined(JERRY_BUILTIN_ARRAY) && (JERRY_BUILTIN_ARRAY == 1) && !defined (CONFIG_DISABLE_ES2015_ITERATOR_BUILTIN)
