...
def add_build_args(parser):
    ...
    parser.add_argument('--jerry-libc', choices=['on', 'off'], default='off', help='Use jerry-libc (default: %(default)s)')
    parser.add_argument('--compiler-default-libc', choices=['on', 'off'], default='on', help='Use compiler-default libc (default: %(default)s)')
